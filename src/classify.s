...
classify:
    ...
    # Compute a0 = t0 * t1 without using 'mul'
    mv t2, t0       # t2 = multiplicand
    mv t3, t1       # t3 = multiplier
    li a0, 0        # a0 = 0 (accumulator)
mul_loop1:
...
mul_done1:
    ...
    lw t0, 0(s3)       # m0 rows
    lw t1, 0(s8)       # input cols
    # Compute a1 = t0 * t1 without using 'mul'
    mv t2, t0
    mv t3, t1
    li a1, 0
mul_loop2:
    beq t3, zero, mul_done2
    andi t4, t3, 1
